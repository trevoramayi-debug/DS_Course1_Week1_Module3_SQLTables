...
df_boston = pd.read_sql(query, conn)
...
df_zero_emp = pd.read_sql(query, conn)
...
df_product_sold = pd.read_sql(query, conn)
...
df_total_customers = pd.read_sql(query, conn)
